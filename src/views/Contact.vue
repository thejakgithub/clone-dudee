<template>
  <div class="bg-white">
    <img
      src="../assets/img/header-contact.jpeg"
      alt="header-contact"
      class="
        absolute
        top-0
    ...
    <main class="mx-auto xl:max-w-7xl lg:max-w-5xl font-maven-pro relative">
      <div class="lg:px-12">
        <div>
          ...
          <div class="bg-white lg:rounded-lg lg:mt-2 p-3">
            <div class="p-3">
              <input
                type="text"
                placeholder="Name"
                class="
                  ...
                  w-full
                  text-base
                  border-[0.7px] border-solid border-gray-400
                  font-asap
                "
              />
            </div>
            ...
            <div class="mx-3 mb-4">
              <h1 class="lg:text-7xl text-[2rem] font-maven-pro pt-9">Map</h1>
              <div>
                <iframe
                  title="map"
                  class="
